...
export default function PostHeader({ post, siteInfo }) {
  ...
  return (
    <div id="header" className="w-full relative md:flex-shrink-0 z-10 flex flex-wrap items-center justify-center">
      <header
        id='article-header-cover'
        className="bg-black bg-opacity-70 w-full md:w-2/3 h-80 py-10 flex flex-wrap items-center justify-center md:absolute md:right-0"
      >
        {/* 文章Title */}
        <div className="leading-snug font-bold xs:text-4xl sm:text-4xl md:text-5xl md:leading-snug text-4xl shadow-text-md text-white text-center md:text-right md:w-2/3">
