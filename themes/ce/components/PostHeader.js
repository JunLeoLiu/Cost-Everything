  ...
  return (
    <div id="header" className="w-60 h-10 relative md:flex-shrink-0 z-50" >
      <header id='article-header-cover'
            className="absolute top-0 w-full h-25 py-2 flex justify-center items-center ">

        <div className='mt-0.5'>
          {/* 文章Title */}
          <div className="leading-snug font-bold xs:text-3xl sm:text-3xl md:text-4xl md:leading-snug text-3xl shadow-text-md flex justify-center text-center text-balck dark:text-gray-400">
          ...
          <section className="flex-wrap shadow-text-md flex text-sm justify-center mt-2 text-white dark:text-gray-400 font-light leading-6">
            ...
            <div className='flex justify-center text-balck dark:text-gray-200 text-opacity-70'>
              {post?.type !== 'Page' && (
                <>
