...
const Hero = props => {
  ...
  return (
        ...
        >
            ...
            <div className="text-white absolute bottom-100 flex flex-col h-full items-center justify-center w-full ">
                {/* 站点标题 */}
                <div className='font-black text-4xl md:text-5xl shadow-text' style={{ bottom: '-20px' }}>{siteConfig('TITLE')}</div>
                {/* 站点欢迎语 */}
