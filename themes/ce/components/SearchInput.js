  ...
  return (
    <div className={'flex w-full rounded-lg ' + className}>
      <input
        ...
        type="text"
        className={
          'outline-none w-full text-sm pl-5 rounded-lg transition focus:shadow-lg dark:text-gray-300 font-light leading-10 text-black bg-gray-200 dark:bg-gray-300'
        }
        onKeyUp={handleKeyUp}
