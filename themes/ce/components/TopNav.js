...
return (
  <div id='top-nav' className='z-40 fixed top-0 w-full'>
    ...
    {/* 导航栏 */}
    <div id='sticky-nav' style={{ backdropFilter: 'blur(3px)' }} className={'duration-300 transition-all shadow-none bg-transparent dark:bg-transparent dark:text-gray-200 text-black w-full z-20 border-none dark:border-none'}>
