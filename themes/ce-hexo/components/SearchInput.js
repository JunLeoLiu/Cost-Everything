  ...
  return (
    <div className={'flex w-full rounded-lg ' + className}>
      <input
        ...
        style={{ height: '50px' }}
        className={
          'outline-none w-full text-sm pl-5 rounded-lg transition focus:shadow-lg dark:text-gray-300 font-light leading-10 text-black bg-gray-150 dark:bg-gray-500 text-center'
        }
        onKeyUp={handleKeyUp}
