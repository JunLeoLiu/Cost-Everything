...
export function InfoCard(props) {
  ...
  return (
    <Card className={className}>
      ...
      <div className='text-sm text-center' style={{ marginBottom: '5px' }}>{siteConfig('BIO')}</div>
      <div className='text-sm text-center' style={{ marginBottom: '5px' }}>E-mail: CE@costeverything.com</div>
      <div className='text-sm text-center' style={{ marginBottom: '5px' }}>www.costeverything.com</div>
      <MenuGroupCard {...props} />
      <SocialButton />
    </Card>
  )
