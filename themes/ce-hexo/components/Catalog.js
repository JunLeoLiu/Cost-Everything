...
const Catalog = ({ toc }) => {
  ...
  return (
    <div className="catalog-wrapper">
      <div className='fixed top-40 right-20 px-1 py-1' style={{ width: '200px' }}>
        <div className='w-full'><i className='mr-1 fas fa-stream' style={{ color: isdarkMode ? 'white' : 'black' }} />{locale.COMMON.TABLE_OF_CONTENTS}</div>
