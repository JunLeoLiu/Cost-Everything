...
export default function RightFloatArea({ floatSlot }) {
  ...
  return (
        <div className={(showFloatButton ? 'opacity-100 ' : 'invisible opacity-0') + '  duration-300 transition-all bottom-12 right-1 fixed justify-end z-20 text-black rounded-sm'}>
