...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'ce-hexo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '价值判断的第一步是合理的成本分析',
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'CE@costeverything.com', // 邮箱地址 例如mail@tangly1024.com
